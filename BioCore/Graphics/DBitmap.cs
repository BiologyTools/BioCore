...
using BitmapX = SharpDX.Direct2D1.Bitmap;
...
namespace BioCore
{
    ...
    class DBitmap
    {
        ...
        public static BitmapX FromImage(RenderTarget renderTarget, AForge.Bitmap image)
        {
            ...
            return new BitmapX(renderTarget, size, new DataPointer(image.GetRGBData(), image.Width * 4 * image.Height), image.Width * 4, bitmapProperties);
        }
